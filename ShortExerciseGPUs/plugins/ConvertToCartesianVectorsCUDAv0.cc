...
using namespace CUDAv0;

class ConvertToCartesianVectorsCUDAv0 : public edm::stream::EDProducer<> {
public:
  explicit ConvertToCartesianVectorsCUDAv0(const edm::ParameterSet&);
  ~ConvertToCartesianVectorsCUDAv0() = default;
...
ConvertToCartesianVectorsCUDAv0::ConvertToCartesianVectorsCUDAv0(const edm::ParameterSet& config)
...
void ConvertToCartesianVectorsCUDAv0::produce(edm::Event& event, const edm::EventSetup& setup) {
...
void ConvertToCartesianVectorsCUDAv0::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(ConvertToCartesianVectorsCUDAv0);
